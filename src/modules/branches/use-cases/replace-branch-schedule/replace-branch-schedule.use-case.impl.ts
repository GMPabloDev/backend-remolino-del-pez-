import type { BranchRepository, BranchWithRelations, CreateIntervalData } from "../../repositories/branch.repository";
 ...
 */
function hasOverlaps(intervals: { dayOfWeek: number; startMinute: number; endMinute: number }[]): boolean {
...
export class ReplaceBranchScheduleUseCaseImpl implements ReplaceBranchScheduleUseCase {
